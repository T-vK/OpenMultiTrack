        ...
        for (f in 0 until frames) {
            ...
            for (ch in channelRange) {
                val int24 = when (subframeBytes) {
                    ...
                    2 -> {
                        val p = frameBase + ch * 2
                        val sample = (src[p].toInt() and 0xFF) or ((src[p + 1].toInt() and 0xFF) shl 8)
