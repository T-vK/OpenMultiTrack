...
private fun buildSettingsRows(
    ...
    SettingsSliderRow(
        ...
        description = "Default visible time span on channel strips when recording or monitoring starts.",
    ...
    SettingsSliderRow(
        id = "record_waveform_history",
        category = SettingsCategory.DISPLAY,
        title = "Live waveform history",
        description = "How many seconds of peaks are kept in memory. Sets the maximum zoom-out while recording.",
        value = state.recordWaveformHistorySec,
        valueRange = org.openmultitrack.app.ui.daw.RecordViewLayout.MIN_HISTORY_SEC..
            org.openmultitrack.app.ui.daw.RecordViewLayout.MAX_HISTORY_SEC,
        valueLabel = "${state.recordWaveformHistorySec.toInt()} s",
        onValueChange = onRecordWaveformHistoryChange,
    ),
    SettingsSliderRow(
